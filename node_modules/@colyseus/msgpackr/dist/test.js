(function (chai, stream, module, fs) {
	...
	if (!nativeAccelerationDisabled) {
		...
		try {
			if (typeof require == 'function')
				...
				extractor = module.createRequire((_documentCurrentScript && _documentCurrentScript.src || new URL('test.js', document.baseURI).href))('msgpackr-extract');
			if (extractor)
	...
	let allSampleData = [];
	for (let i = 1; i < 6; i++) {
		allSampleData.push(JSON.parse(fs.readFileSync(new URL(`./example${i > 1 ? i : ''}.json`, (_documentCurrentScript && _documentCurrentScript.src || new URL('test.js', document.baseURI).href)))));
	}
	allSampleData.push({
